...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-unit-test-private-methods](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-unit-test-private-methods)
...
[![Code coverage of our methods](../Images/52f58df02647b884260bef8b98213473.png)](/web/20220815003257/https://www.baeldung.com/wp-content/uploads/2022/06/public-and-private-method-code-coverage.png) 正如我们所看到的，我们的私有方法中的空值检查并不包含在我们的单元测试中。那我们应该测试它吗？
...
为了测试它，**如果我们的私有方法有另一个可见性**会很有帮助。好消息是**我们将能够用[反射](/web/20220815003257/https://www.baeldung.com/java-reflection)T5】来模拟。**
