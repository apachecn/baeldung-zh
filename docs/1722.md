...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/JSP](https://web.archive.org/web/20220930061024/https://www.baeldung.com/jsp)
...
**out**
T0】属于`javax.servlet.jsp.JspWriter`类，用于向客户端写入内容。
...
**config**
T0】属于类`javax.servlet.ServletConfig`是 servlet 配置对象，允许获取 servlet 上下文、名称和配置参数。
...
**trim directive white spaces**T0】
