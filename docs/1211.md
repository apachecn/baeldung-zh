...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-stack-overflow-error](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-stack-overflow-error)
...
当一个应用程序被设计成在类之间有**c**T3】循环关系时，也可以抛出 `StackOverflowError`。在这种情况下，彼此的构造函数会被重复调用，从而引发此错误。这也可以被认为是递归的一种形式。
