...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-synchronized-collections](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-synchronized-collections)
...
**同步的集合通过[intrinsi](https://web.archive.org/web/20221121030850/https://docs.oracle.com/javase/tutorial/essential/concurrency/locksync.html)T3】c 锁实现线程安全，整个集合被锁定**。内在锁定是通过包装集合的方法中的同步块实现的。
