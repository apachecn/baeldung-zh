...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-reflection-change-annotation-params](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-reflection-change-annotation-params)
...
Java 类*T5】类* 有字段 `annotations`。由于这是一个私有字段，要访问它，我们必须将字段的可访问性设置为`true`。Java 提供了方法*getDeclaredField*来通过名称访问任何字段
