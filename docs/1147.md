...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-null-safe-streams-from-collections](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-null-safe-streams-from-collections)
...
### **4.2。使用来自`CollectionUtils`库**的`emptyIfNull`方法
