...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/spring-boot-security-auto configuration](https://web.archive.org/web/20220930061024/https://www.baeldung.com/spring-boot-security-autoconfiguration)
...
这些端点包括静态资源，如/css/**、/js/**、/images/**、/webjars/**、/**/favicon.ico 和错误端点。如果我们需要允许对这些端点进行未经身份验证的访问，我们可以显式地进行配置。
