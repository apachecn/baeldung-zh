...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/spring-security-oauth 2-refresh-token-angular](https://web.archive.org/web/20220930061024/https://www.baeldung.com/spring-security-oauth2-refresh-token-angular)

 ![](../Images/9a85e7b00890e39c43fce777070ff81b.png)
...
前端客户端现在将作为引导应用程序托管，以便我们可以使用 Spring Cloud Zuul starter 无缝连接到我们的嵌入式 Zuul 代理。 **T2】**
