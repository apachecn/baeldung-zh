...
[![main screen.png](../Images/d0f60596c70ee757d7cb3baaa8ad6732.png)](/web/20220927082854/https://www.baeldung.com/wp-content/uploads/2019/01/main-screen.png)

在视图的左侧，我们可以看到`General`、`Memory`、`Code`和 `Threads`等部分。每个部分都包含各种选项卡，其中包含详细信息。例如，`Code `部分的`Hot Methods`选项卡包含方法调用的统计信息:

[![code screen hot methods](../Images/e2abf8de7a676d030ad7ea2253b64253.png)](/web/20220927082854/https://www.baeldung.com/wp-content/uploads/2019/01/code-screen-hot-methods.png)
