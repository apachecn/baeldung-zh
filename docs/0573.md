...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-JSON-we B- tokens-jjwt](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-json-web-tokens-jjwt)
...
第 2 行确保传入的 JSON 被自动转换成 Java Map <string object="">，这对 JJWT 来说非常方便，因为第 5 行的方法只需获取该 Map，然后一次性设置所有声明。</string>
...
[![jwt_expired](../Images/613a59ce1e0f51a6d2cfb3ccdb79701f.png)](/web/20220701015023/https://www.baeldung.com/wp-content/uploads/2016/08/jwt_expired.png)
