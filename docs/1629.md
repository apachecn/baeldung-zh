...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-integer-parse int-vs-value of](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-integer-parseint-vs-valueof)
...
现在，让我们来理解用基数进行字符串转换是如何发生的。例如，在基数为 13 的数字系统中，诸如 398 的数字串表示十进制数(基数/基数为 10) 632。换句话说，在这种情况下，计算是这样进行的——3×13<sup>2</sup>+9×13<sup>1</sup>+8×13<sup>0</sup>= 632。

同样，在上面的例子中`Integer.parseInt(“11”, 16)`通过计算得出 17，1×16<sup>1</sup>+1×16<sup>0</sup>= 17。
