...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/spring-deprecated-classes](https://web.archive.org/web/20220930061024/https://www.baeldung.com/spring-deprecated-classes)

 ![](../Images/d4cb3fc947cf3ce99113e22e8adead76.png)
...
*   `**org.springframework.http.converter.xml.XmlAwareFormHttpMessageConverter**``–`T2】
...
*   `**org.springframework.jdbc.core.simple.ParameterizedBeanPropertyRowMapper**``–`T2】
*   `**org.springframework.jdbc.core.simple.ParameterizedSingleColumnRowMapper**``–`T2】
...
*   `**org.springframework.format.number.CurrencyFormatter**``–`T2】
...
*   `**org.springframework.format.number.NumberFormatter**``–`T2】
*   `**org.springframework.format.number.PercentFormatter**``–`T2】
...
*   `**org.springframework.web.servlet.ResourceServlet**``–`T2】
...
*   `**org.springframework.web.util.AbstractUriTemplateHandler**` `–`T2】
...
*   `**org.springframework.web.client.AsyncRestTemplate **``–`T2】
...
*   `**org.springframework.core.io.PathResource **``–`T2】
...
*   `**org.springframework.remoting.caucho.SimpleHessianServiceExporter **``–`T2】
*   `**org.springframework.remoting.httpinvoker.SimpleHttpInvokerServiceExporter**` `–`T2】
*   `**org.springframework.remoting.support.SimpleHttpServerFactoryBean **` `–`嵌入式雄猫/突堤/回流
*   `**org.springframework.remoting.jaxws.SimpleHttpServerJaxWsServiceExporter **``–`T2】
...
*   `**org.springframework.boot.test.ConfigFileApplicationContextInitializer **``–`T2】
*   `**org.springframework.boot.yaml.DefaultProfileDocumentMatcher **` `–`它不再被使用
*   `**org.springframework.boot.context.embedded.DelegatingFilterProxyRegistrationBean **``–`T2】
*   `**org.springframework.boot.actuate.system.EmbeddedServerPortFileWriter **``–`T2】
*   `**org.springframework.boot.test.EnvironmentTestUtils **``–`T2】
*   `**org.springframework.boot.context.embedded.ErrorPage **``–`T2】
*   `**org.springframework.boot.context.web.ErrorPageFilter **``–`T2】
*   `**org.springframework.boot.context.embedded.FilterRegistrationBean **``–`T2】
*   `**org.springframework.boot.test.IntegrationTestPropertiesListener **``–``@IntegrationTest`不再使用
*   `**org.springframework.boot.context.embedded.MultipartConfigFactory **``–`T2】
*   `**org.springframework.boot.context.web.OrderedCharacterEncodingFilter **``–`T2】
*   `**org.springframework.boot.context.web.OrderedHiddenHttpMethodFilter **``–`T2】
*   `**org.springframework.boot.context.web.OrderedHttpPutFormContentFilter **``–`T2】
*   `**org.springframework.boot.context.web.OrderedRequestContextFilter **``–`T2】
*   `**org.springframework.boot.test.OutputCapture **``–`T2】
*   **`org.springframework.boot.context.web.ServerPortInfoApplicationContextInitializer`**`–`T2】
*   `**org.springframework.boot.context.web.ServletContextApplicationContextInitializer**` `–`T2】
*   `**org.springframework.boot.context.embedded.ServletListenerRegistrationBean **``–`T2】
*   `**org.springframework.boot.context.embedded.ServletRegistrationBean **``–`T2】
...
*   `**org.springframework.boot.test.SpringBootMockServletContext **``–`T2】
*   `**org.springframework.boot.context.web.SpringBootServletInitializer **``–`T2】
*   `**org.springframework.boot.test.TestRestTemplate **``–`T2】
