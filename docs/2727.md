...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-Apache-derby](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-apache-derby)
...
**如果我们 做 不做 指定默认值 ，NULL则 插入 中的 列 为T47】**
