...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-performance-mapping-frameworks](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-performance-mapping-frameworks)
...
| JMapper | 10 <sup>-4</sup> | Zero point zero zero one | One point five two six |
| MapStruct | 10 <sup>-4</sup> | 10 <sup>-4</sup> | One point nine four eight |
...
|  | 采样时间(每次操作的毫秒数) |
| 框架名称 | p0.90 | p0.999 | p1.0 |
| JMapper | 10 <sup>-3</sup> | Zero point zero zero six | three |
| MapStruct | 10 <sup>-3</sup> | Zero point zero zero six | eight |
