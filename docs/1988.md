...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/axon-cqrs-event-sourcing](https://web.archive.org/web/20220930061024/https://www.baeldung.com/axon-cqrs-event-sourcing)
...
首先，**由于我们希望利用事件源为我们的聚合服务，我们需要一个`[EventStore](https://web.archive.org/web/20220926201149/https://docs.axoniq.io/reference-guide/axon-framework/events/event-bus-and-event-store).`** Axon 服务器，我们在第三步中启动的服务器将填补这个漏洞。**T5】**
