...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/JUnit-test watcher](https://web.archive.org/web/20220930061024/https://www.baeldung.com/junit-testwatcher)

## **1。概述**

当进行单元测试时，我们可能会周期性地希望处理测试方法执行的结果。在这个快速教程中，**我们将看看如何使用由[JUnit](https://web.archive.org/web/20221127014133/http://junit.org/junit5/)T3】提供的 TestWatcher API 来完成这个任务。**
