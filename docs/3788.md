...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/arrays-sort object-vs-sort int](https://web.archive.org/web/20220930061024/https://www.baeldung.com/arrays-sortobject-vs-sortint)
...
虽然，**在最坏的情况下，其时间复杂度是`O(n<sup>2</sup>)`。**
