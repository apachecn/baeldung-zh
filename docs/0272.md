...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/JNI](https://web.archive.org/web/20220930061024/https://www.baeldung.com/jni)
...
**我们可以在 [Oracle 官方文档中检查 Java 类型和 C JNI 类型的等价性。](https://web.archive.org/web/20221104023238/https://docs.oracle.com/en/java/javase/11/docs/specs/jni/types.html)T3】**
