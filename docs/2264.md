...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-statement-prepared statement](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-statement-preparedstatement)
...
第三， **`PreparedStatement`** **采用预编译**。数据库一收到查询，就会在预编译查询之前检查缓存。因此，**如果它没有被缓存，数据库引擎将保存它供下次使用。**T12】
