...
> 原文：<https://web.archive.org/web/20220930061024/https://www.baeldung.com/string/contains>
...
• Java String.contains() (current article)[• Java String.copyValueOf()](/web/20220829143229/https://www.baeldung.com/string/copy-value-of)
...
方法`contains()`检查一个`String`是否包含另一个`String`。该方法接受一个`CharSequence`。因此，我们可以将任何实现类传递给它，比如`StringBuilder`和`StringBuffer`。
...
## Next **»**[Java String.copyValueOf()](/web/20220829143229/https://www.baeldung.com/string/copy-value-of)**«** Previous[Java String.concat()](/web/20220829143229/https://www.baeldung.com/string/concat)