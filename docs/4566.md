...
#### [**=>Java 8 cheat sheet**T3】](https://web.archive.org/web/20220812060715/http://www.java8.org/)
...
#### [**= >网上研讨会回放:Apache Tomcat 8** 简介 T3】](https://web.archive.org/web/20220812060715/https://spring.io/blog/2014/02/18/webinar-replay-introduction-to-apache-tomcat-8)

这几乎不需要介绍——如果您正在使用 Tomcat 进行任何工作，那么它绝对值得您花费一个小时的时间。

#### [**=>Spring MVC 中链接 URL 视图解析器**T3】](https://web.archive.org/web/20220812060715/http://blog.frankel.ch/chaining-url-view-resolvers-in-spring-mvc)
