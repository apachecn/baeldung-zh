...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/spring-cloud-sidecar-intro](https://web.archive.org/web/20220930061024/https://www.baeldung.com/spring-cloud-sidecar-intro)
...
`@EnableSidecar`不仅仅是在尤里卡注册侧服务的标志。这也导致添加了`@EnableCircuitBreaker`和`@EnableZuulProxy`，随后，我们的 Spring Boot 应用程序受益于 [Hystrix](/web/20221128051913/https://www.baeldung.com/introduction-to-hystrix) 和[Zuul](/web/20221128051913/https://www.baeldung.com/spring-rest-with-zuul-proxy)T3】
