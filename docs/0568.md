...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/spring-controller-vs-rest controller](https://web.archive.org/web/20220930061024/https://www.baeldung.com/spring-controller-vs-restcontroller)
...
为了简化 RESTful web 服务的创建，Spring 4.0 引入了`@RestController`注释。**是一个结合了`@Controller`和`@ResponseBody`T5】的方便的注释，它消除了用`@ResponseBody`注释来注释控制器类的每个请求处理方法的需要。**
