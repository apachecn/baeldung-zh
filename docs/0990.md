...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/spring-boot-key cloak](https://web.archive.org/web/20220930061024/https://www.baeldung.com/spring-boot-keycloak)
...
[![keycloak1](../Images/43c3787201343787087963a9df25cb29.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/keycloak1.png)

让我们创建一个名为`initial1`的初始管理员用户，密码为`zaq1!QAZ`。点击`Create`，我们会看到信息`User Created`。

我们现在可以进入管理控制台。在登录页面上，我们将输入初始管理员用户凭据:

[![keycloak admin console](../Images/4515d7741b8185f4f980626421f7e0f6.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2021/06/1_keycloak_admin_console.png)
...
[![keycloak add realm](../Images/d55d37a26190923c4e22f372f35153ee.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/2_keycloak_add_realm.png)

在下一个屏幕上，**让我们添加一个名为`SpringBootKeycloak` :** 的新领域

[![keycloak new realm](../Images/0a1da70a266f88c5d03fedf17c7006bc.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/keycloak-new-realm.png)
...
[![keycloak clients](../Images/686c8dba379837c88809b933d0d5c2dd.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/keycloak-clients.png)

我们仍然需要向我们的应用程序添加一个新的客户端，所以我们将单击`Create`。**我们称新客户为`login-app` `:`**

[![keycloak add client 1](../Images/7eee10671d16e4c8d427aef0c8cd97d0.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/keycloak-add-client-1.png)

在下一个屏幕中，出于本教程的目的，我们将保留除**字段之外的所有默认值。该字段应包含将使用该客户端进行身份验证的应用程序 URL**:

[![keycloak valid redirect uris](../Images/d344248aac4f1a9272b232b7c3baaf06.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/keycloak-valid-redirect-uris.png)
...
[![keycloak roles](../Images/8c5bfca452fcf91e27ad5f62148d8cc2.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/3_keycloak_roles.png)

然后我们将添加`user`角色:

[![keycloak add role](../Images/cf6057259f52f0a358804c88106b4efb.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/keycloak-add-role.png)

现在我们有了一个可以分配给用户的角色，但是由于还没有用户，**让我们转到`Users`页面并添加一个:**

[![keycloak users](../Images/d43624ff5e408872ced16038e8570363.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/keycloak-users.png)

我们将添加一个名为`user1:`的用户

[![keycloak adduser](../Images/d6ecd6a62a61eb8ba8152d8b1e4a5480.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/4_keycloak_adduser.png)

创建用户后，将显示一个包含其详细信息的页面:

[![keycloak user](../Images/3d51e5e0660247f6a35592a4b36a29f6.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/keycloak-user.png)

我们现在可以转到`Credentials`选项卡。我们将初始密码设置为`[[email protected]](/web/20220924064051/https://www.baeldung.com/cdn-cgi/l/email-protection)`:

[![keycloak credentials](../Images/431887784521a2dd8011d5be3c09238d.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/keycloak-credentials.png)

最后，我们将导航到`Role Mappings`选项卡。我们将把`user`角色分配给我们的`user1`:

[![keycloak userrole](../Images/a2dfa45c01063c24a214dd7c6fe9b81d.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/5_keycloak_userrole.png)
...
[![externalFacingKeycloakPage e1551248465138](../Images/52d5aab63d55a82a47292269a33fddf9.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/externalFacingKeycloakPage.png)

现在我们点击`customers`进入内网，这是敏感信息的位置。

**请注意，我们已被重定向到通过 Keycloak 进行身份验证，以查看我们是否有权查看此内容:**

[![keycloak userlogin](../Images/ab4b0ed23f8af430d1dd99b5b16c4791.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/6_keycloak_userlogin.png)

一旦我们以`user1`的身份登录，Keycloak 将验证我们的授权，证明我们拥有`user`角色，我们将被重定向到受限的`customers`页面:

[![customers page](../Images/615e0cbc088ed60b8d7e4a6fe3398b56.png)](/web/20220924064051/https://www.baeldung.com/wp-content/uploads/2017/11/customers-page.png)
