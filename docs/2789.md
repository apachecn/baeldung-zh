...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-work-stealing](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-work-stealing)
...
**分解的任务在[线程池](/web/20221205163736/https://www.baeldung.com/thread-pool-java-and-guava)T3】提供的工作线程的帮助下解决。每个工作线程都有它负责的子任务。这些存储在双端队列中([队列](/web/20221205163736/https://www.baeldung.com/java-queue#3-deques))。**
