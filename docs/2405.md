...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/spring-boot-main-class](https://web.archive.org/web/20220930061024/https://www.baeldung.com/spring-boot-main-class)
...
请注意，**只有在我们将[spring-boot-starter-parent](https://web.archive.org/web/20221026041503/https://search.maven.org/classic/#search%7Cga%7C1%7Cg%3A%22org.springframework.boot%22%20AND%20a%3A%22spring-boot-maven-plugin%22)T5】作为`<parent>`添加到我们的`pom.xml`中时，才会对该属性进行评估。**
