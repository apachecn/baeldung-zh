...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/hibernate-proxy-to-real-entity-object](https://web.archive.org/web/20220930061024/https://www.baeldung.com/hibernate-proxy-to-real-entity-object)
...
**在这里，我们可以看到，在使用代理时，Hibernate 只执行了一条 `INSERT ` 语句，用于 `Payment`**  **的创建。T12】**
