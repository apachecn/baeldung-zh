...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/spring-thyme leaf-3-expressions](https://web.archive.org/web/20220930061024/https://www.baeldung.com/spring-thymeleaf-3-expressions)
...
我们可以从检查空或`null`T1】对象的实用程序开始描述。开发人员经常会在百里香标签中使用 Java 方法来实现这一点，这对`null`对象来说可能不安全。
