...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-string-performance](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-string-performance)
...
### **3.1。`StringUtils.replace()`vs`String.replace()`T3】**
...
### **3.5。`String.matches()`vs`Precompiled Pattern`T3】**
