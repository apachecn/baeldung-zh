...
> 原文:[https://web . archive . org/web/20220930061024/https://www . bael dung . com/Java-compiler-release-option](https://web.archive.org/web/20220930061024/https://www.baeldung.com/java-compiler-release-option)
...
*   对于 N < 9，`-source`N`-target`N`-bootclasspath`T3】documented-APIs-from-N>
*   对于 N >= 9，`-source`N`-target`N`–system`T3】documented-APIs-from-N>
